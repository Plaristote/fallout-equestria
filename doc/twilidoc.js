...
(function() {
  var ATTR_CONST, ATTR_INLINE, ATTR_PTR, ATTR_REF, ATTR_STATIC, ATTR_TYPEDEF, ATTR_UNSIGNED, ATTR_VIRTUAL, AnchorHandle, Attribute, Breadcrumb, Class, ClassList, Homepage, Member, Menu, MenuEntry, Project, View, VisibilityHandle, Widget,
    ...
    Attribute.prototype.TypeBox = function(name, attrs, classname, is_typedef) {
      ...
      if (classname != null) {
        ...
        if (!(is_typedef && type === null)) {
          html += " onclick='location.hash=\"#show-class-" + classname + "\"'";
        }
        desc = type === null ? 'Undocumented type' : type.doc;
  ...
  Member = (function(_super) {
    ...
    Member.prototype.RenderAttribute = function(attribute) {
      ...
      if (attribute.doc != null) {
        html += '<dl>';
        if (attribute.doc.desc != null) {
          html += "<dt>Overview</dt><dd>" + attribute.doc.desc + "</dd>";
        }
        html += '</dl>';
      }
      html += "</span>";
